...
<form action="<?php echo e(route('users.posts.store',['user' => Auth::id()])); ?>"  method="POST" class="form-box">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Title" value="<?php echo e(old('title')); ?>" name="title" id="title" >
    ...
    <textarea value="<?php echo e(old('content')); ?>"  name="content" id="content"></textarea>
...
</html><?php /**PATH D:\xampp\htdocs\gates-policies\resources\views/user/create-post.blade.php ENDPATH**/ ?>